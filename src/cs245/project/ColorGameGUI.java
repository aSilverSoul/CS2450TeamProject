...
*
* purpose: This GUI file works along with ColorGame.java
* this deals with the colors of the buttons, highlighting, and shapes.
* 
*
****************************************************************/ 
...
public class ColorGameGUI extends javax.swing.JFrame {
    ...
    public void initRandomColors(){
        ...
        for (int i = colorList.length - 1; i > 0; i--)
        {
          ...
          // swap colors
          String oneColor = colorList[index];
          colorList[index] = colorList[i];
          colorList[i] = oneColor;
        }
        ...
        for(int i = 0; i < colorList.length; ++i){
            ...
            switch(i){
                case 0:
                    colorImagePath = "/cs245/project/hangman_images/circle_" + 
                            colorList[i] + ".png";
                    icon = new ImageIcon(getClass().getResource(colorImagePath));
    ...
    private void initComponents() {
        ...
        colorLabel.setBounds(240, 120, 110, 50);

        colorBtn1.setToolTipText("Click the button!");
        ...
        colorBtn1.setBounds(40, 60, 120, 120);

        colorBtn2.setToolTipText("click the button!");
        ...
        colorBtn2.setBounds(20, 250, 120, 120);

        colorBtn3.setToolTipText("click the button");
        ...
        colorBtn3.setBounds(450, 260, 120, 120);

        colorBtn4.setToolTipText("click the button!");
        ...
        colorBtn4.setBounds(440, 60, 120, 120);

        colorBtn5.setToolTipText("click the button");
        ...
        colorBtn5.setBounds(230, 250, 120, 120);
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/cs245/project/hangman_images/white.png"))); // NOI18N
